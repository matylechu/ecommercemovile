...
const Carrito = () => {
    ...
    const isCartEmpty = cart.lenght === 0
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.footerContainer}>
                <TouchableOpacity disabled={isCartEmpty} style={isCartEmpty ? styles.buttonDisabled : styles.buttonConfirm} onPress={onConfirmOrder}>
